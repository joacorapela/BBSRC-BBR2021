...
\begin{tikzpicture}[
  ...
  \node[text width=10em, font={\bf}, align=center]
       (bonsai)
       {\includegraphics[width=5em]{bonsai-lettering}\\
         Bonsai core (C\#)};

       
  \coordinate [above right = 2.5ex and 13em of bonsai.east] (A);
  \draw[<->, line width=1mm, gray] (bonsai.east) ++(-2em,0) -- +(2.5em,0);
 ...
 \coordinate [below left = 11em and 5em of A] (B);
 \draw[<->, line width=1mm, gray] (intr box.south) -- +(0,-2.5em);
