...
experiments and analyze their data. This
...
%
To demonstate the use of this infrastructure, and to provide Bonsai users with
...
neuroscience experiments and to analyze data generated by them
(Section~\ref{sec:functionality}).
...
developers recognize this potentials, they will become interested in
...
propose to add functionality for video-based behavioral analysis
...
To assess the progress of the proposed project, we propose the following
measurable targets:

\begin{description}

    \item[implementation of software infrastructure]
        (Section~\ref{sec:softwareInfrastructure}) includes the
        implementation of the machine abstractions described in Section~\ref{}
        and of the capabilities to be added to Bonsai to communicate with
    ...
    \item[implementation of functionality] (Sections~\ref{sec:functionality})
        includes the integration into Bonsai of machine learning software
        for video-based behavioral analysis (Section~\ref{}) and for
        brain-computer-interface applications (Section~\ref{}). Completion of
        this target requires that Bonsai can perform these tasks interacting
    ...
    \item method developers integrate their methods into the Bonsai ecosystem.
        ...
        Bonsai's package manager. We propose to use this package manaer to tack
