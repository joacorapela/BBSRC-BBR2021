...
disassociated.  Most neuroscientists collect their data and only after ward
...
data analysis methods that will trigger advanced in machine learning.
...
repertoire of advance machine learning methods for their behavioural and neural
data analysis.

Developers of advanced data-analysis methods should become interested in
integrating them into the Bonsai ecosystem, which will allow their methods to
...
programming language that emphasises performance, flexibility, and ease-of-use,
...
Quantification of this user base are provided in Figures 1d-1f.  In the last
